...
if (!class_exists('SHOPME_COMPARE_MOD')) {
	...
	class SHOPME_COMPARE_MOD extends SHOPME_PLUGINS_CONFIG {
		...
		function __construct() {
			...
			if ( !defined( 'YITH_WOOCOMPARE' ) && !class_exists('WooCommerce') ) return;
			...
			if ( get_option('yith_woocompare_compare_button_in_products_list') == 'yes' ) {
				add_action('shopme-product-actions-after', create_function('', 'echo do_shortcode( "[yith_compare_button container=\'\']" );') );
			}
