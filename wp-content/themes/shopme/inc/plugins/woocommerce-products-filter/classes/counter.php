...
if (!class_exists('SHOPME_WP_QueryWoofCounter')) {


	final class SHOPME_WP_QueryWoofCounter
	{
		...
		public function __construct($query)
		{
			...
			$this->table = SHOPME_WOOF::$query_cache_table;
			//***
			$woof_settings = get_option('shopme_woof_settings', array());
			...
			if (true)  {
				...
				{
					$q = new SHOPME_WP_QueryWOOFCounterIn($query);
...
if (!class_exists('SHOPME_WP_QueryWOOFCounterIn')) {

	final class SHOPME_WP_QueryWOOFCounterIn extends WP_Query
	{
