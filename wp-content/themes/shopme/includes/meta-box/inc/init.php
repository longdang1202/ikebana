...
add_action( 'admin_init', 'shopme_rwmb_register_meta_boxes' );
...
function shopme_rwmb_register_meta_boxes() {
...
add_action( 'edit_page_form', 'shopme_rwmb_fix_page_template' );
 ...
 * @since 4.3.10
 */
function shopme_rwmb_fix_page_template( $post )
{
