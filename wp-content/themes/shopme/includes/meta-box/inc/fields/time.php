...
if ( ! class_exists( 'RWMB_Time_Field' ) )
{
	class RWMB_Time_Field extends RWMB_Field
	{
		...
		static function admin_enqueue_scripts( )
		{
			...
			wp_enqueue_script( SHOPME_PREFIX . 'rwmb-time', RWMB_JS_URL.'time.js', $deps, RWMB_VER, true );
			wp_localize_script( SHOPME_PREFIX . 'rwmb-time', 'RWMB_Timepicker', array( 'lang' => $locale ) );
		}
