...
if ( ! class_exists( 'RWMB_Datetime_Field' ) )
{
	class RWMB_Datetime_Field extends RWMB_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_enqueue_script( SHOPME_PREFIX . 'rwmb-datetime', RWMB_JS_URL . 'datetime.js', $deps, RWMB_VER, true );
			wp_localize_script( SHOPME_PREFIX . 'rwmb-datetime', 'RWMB_Datetimepicker', array( 'lang' => $locale ) );
		}
