...
if ( ! class_exists( 'RWMB_Image_Select_Field' ) )
{
	class RWMB_Image_Select_Field extends RWMB_Field
	{
		...
		{
			wp_enqueue_style( SHOPME_PREFIX . 'rwmb-image-select', RWMB_CSS_URL . 'image-select.css', array(), RWMB_VER );
			wp_enqueue_script( SHOPME_PREFIX . 'rwmb-image-select', RWMB_JS_URL . 'image-select.js', array( 'jquery' ), RWMB_VER, true );
		}
