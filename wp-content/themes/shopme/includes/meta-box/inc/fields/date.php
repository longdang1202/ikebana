...
if ( ! class_exists( 'RWMB_Date_Field' ) )
{
	class RWMB_Date_Field extends RWMB_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_enqueue_script( SHOPME_PREFIX . 'rwmb-date', RWMB_JS_URL . 'date.js', $deps, RWMB_VER, true );
			wp_localize_script( SHOPME_PREFIX . 'rwmb-date', 'RWMB_Datepicker', array( 'lang' => $locale ) );
		}
