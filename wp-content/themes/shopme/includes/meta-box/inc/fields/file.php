	...
	class RWMB_File_Field extends RWMB_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( SHOPME_PREFIX . 'rwmb-file', 'rwmbFile', array(
				'maxFileUploadsSingle' => esc_html__( 'You may only upload maximum %d file', 'rwmb' ),
				'maxFileUploadsPlural' => esc_html__( 'You may only upload maximum %d files', 'rwmb' ),
			) );
		}
		...
		static function wp_ajax_delete_file()
		{
			...
			if ( $ok )
				...
				wp_send_json_error( esc_html__( 'Error: Cannot delete file', 'rwmb' ) );
		}
