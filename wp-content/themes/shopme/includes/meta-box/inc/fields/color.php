...
if ( ! class_exists( 'RWMB_Color_Field' ) )
{
	class RWMB_Color_Field extends RWMB_Field
	{
		...
		{
			wp_enqueue_style( SHOPME_PREFIX . 'rwmb-color', RWMB_CSS_URL . 'color.css', array( 'wp-color-picker' ), RWMB_VER );
			wp_enqueue_script( SHOPME_PREFIX . 'rwmb-color', RWMB_JS_URL . 'color.js', array( 'wp-color-picker' ), RWMB_VER, true );
		}
