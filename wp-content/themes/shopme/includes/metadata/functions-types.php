		...
		<div class="shopme-form-field">
			...
			if ($type == "upload") :  ?>
				...
				<label for='upload_image'>
					...
					<button class="button_upload_image button" id="<?php echo $name ?>"><?php esc_html_e('Upload Image', 'porto') ?></button>
					<button class="button_remove_image button" id="<?php echo $name ?>"><?php esc_html_e('Remove Image', 'porto') ?></button>
				</label>
				<?php if ($desc) : ?><p><?php echo $desc ?></p><?php endif; ?>
			<?php endif;
