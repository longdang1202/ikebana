						...
						<div class="align_right shop_links product">
							...
							<?php if (shopme_custom_get_option('show_wishlist')): ?>
								...
								<?php if (defined('YITH_WCWL') && defined('SHOPME_WOO_CONFIG')):
									...
									<a href="<?php echo esc_url(get_permalink($wishlist_page_id)); ?>" class="wishlist_link small_link <?php echo esc_attr($wishlist_active); ?>"><i class="icon-heart-5"></i><?php esc_html_e('Wishlist', 'shopme'); ?> (<span><?php echo esc_html($wishlist_count) ?></span>)</a>
							...
							<?php if (shopme_custom_get_option('show_compare')):
								...
								if (defined('YITH_WOOCOMPARE') && defined('SHOPME_WOO_CONFIG')):
									...
									<a href="<?php echo esc_url(add_query_arg( array( 'iframe' => 'true' ), $yith_woocompare->obj->view_table_url() )) ?>" class="count-compare compare added small_link"><i class="icon-resize-small"></i><?php esc_html_e('Compare', 'shopme') ?> (<span><?php echo esc_html($count_compare) ?></span>)</a>
