				...
				<?php if (shopme_custom_get_option('show_compare')):
					...
					if (defined('YITH_WOOCOMPARE') && defined('SHOPME_WOO_CONFIG')):
						...
						<div class="nav_item size_1 product">
							<a href="<?php echo esc_url(add_query_arg( array( 'iframe' => 'true' ), $yith_woocompare->obj->view_table_url() )) ?>" class="compare added compare_button" data-amount="<?php echo esc_html($count_compare) ?>"></a>
						</div><!--/ .nav_item-->
