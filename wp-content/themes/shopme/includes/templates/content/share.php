...
<div class="share-links-wrapper v_centered">
	...
	<div class="share-links">
		...
		<?php if (shopme_custom_get_option('share-posts-facebook')): ?>
			<a href="http://www.facebook.com/sharer.php?u=<?php echo $permalink ?>&amp;text=<?php echo $title ?>&amp;images=<?php echo $image ?>" <?php echo $extra_attr ?> title="<?php _e('Facebook', 'shopme') ?>" class="share-facebook"><?php esc_html_e('Facebook', 'shopme') ?></a>
		<?php endif; ?>
