			...
			if (shopme_is_shop_installed()) {
				...
				if (shopme_is_product()) {
					...
					if (empty($result_sidebar_position)) {
						$result = shopme_custom_get_option('sidebar_product_singular_position');
					} else {
...
<!--						<a href="#" class="middle_btn icon_btn social_rss tooltip_container">-->
<!--							<i class="icon-rss"></i><span class="tooltip top">--><?php //esc_html_e('RSS', 'shopme') ?><!--</span>-->
<!--						</a>-->
						...
						<?php if ($args['blog_style'] == 'grid_view' || $args['blog_style'] == 'list_view'): ?>
							<div class="layout_type buttons_row">
								<a href="#" data-table-layout="grid_view" class="button_grey middle_btn icon_btn <?php if ($args['blog_style'] == 'grid_view') { ?>active<?php } ?> tooltip_container"><i class="icon-th"></i><span class="tooltip top"><?php esc_html_e('Grid View', 'shopme') ?></span></a>
								<a href="#" data-table-layout="list_view" class="button_grey middle_btn icon_btn <?php if ($args['blog_style'] == 'list_view') { ?>active<?php } ?> tooltip_container"><i class="icon-th-list"></i><span class="tooltip top"><?php esc_html_e('List View', 'shopme') ?></span></a>
							</div>
						<?php endif; ?>
