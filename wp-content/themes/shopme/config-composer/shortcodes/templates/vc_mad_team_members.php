		...
		<div class="team-members clearfix">
			...
			<?php foreach ($this->entries->posts as $entry): ?>
				...
				<?php
					...
					$position = rwmb_meta('shopme_tm_position', '', $id);

					$facebook = rwmb_meta('shopme_tm_facebook', '', $id);
					$twitter = rwmb_meta('shopme_tm_twitter', '', $id);
					$gplus = rwmb_meta('shopme_tm_gplus', '', $id);
					$pinterest = rwmb_meta('shopme_tm_pinterest', '', $id);
					$instagram = rwmb_meta('shopme_tm_instagram', '', $id);
