...
//			'vc_gmaps',
		...
		public function add_shortcode_params() {
			...
			vc_add_shortcode_param('get_terms', array(&$this, 'param_woocommerce_terms'), $this->assetUrl('js/js_shortcode_products.js'));
			vc_add_shortcode_param('get_by_id', array(&$this, 'param_woocommerce_get_by_id'), $this->assetUrl('js/js_shortcode_products.js'));
		}
