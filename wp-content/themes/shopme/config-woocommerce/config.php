...
if (!class_exists('SHOPME_WOOCOMMERCE_CONFIG')) {
	...
	class SHOPME_WOOCOMMERCE_CONFIG {
		...
		public function woocommerce_button_proceed_to_checkout() {
			...
			?>
			<a href="<?php echo esc_url($checkout_url); ?>" class="checkout-button button_blue middle_btn"><?php esc_html_e( 'Proceed to Checkout', 'woocommerce' ); ?></a>
		<?php
		}
		...
		public function woocommerce_set_defaults() {
			...
			$shopme_config['themeImgSizes']['shop_thumbnail'] = array('width' => 90, 'height' => 90);
			$shopme_config['themeImgSizes']['shop_catalog']   = array('width' => 350, 'height' => 350);
			$shopme_config['themeImgSizes']['shop_single']    = array('width'=> 500, 'height'=> 500);
