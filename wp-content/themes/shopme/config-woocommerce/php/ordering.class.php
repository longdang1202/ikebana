...
if (!class_exists('SHOPME_CATALOG_ORDERING')) {
	...
	class SHOPME_CATALOG_ORDERING {
		...
		public function output_html_with_filter() {
			...
			$per_page_string = esc_html__("Products per page", 'shopme');
			...
			<div class="v_centered">
				...
				<div class="dropdown-list sort-param sort-param-count">
					...
					<ul class="options_list dropdown">
						<li class="animated_item">
							<a <?php echo $this->woo_active_class($product_count_key, $per_page); ?> data-count="<?php echo esc_attr($per_page) ?>" href=""><?php echo (int) esc_html($per_page) . ' ' . $per_page_string ?></a>
						</li>
						<li class="animated_item">
							<a <?php echo $this->woo_active_class($product_count_key, $per_page * 2); ?> data-count="<?php echo esc_attr($per_page * 2) ?>" href=""><?php echo (int) esc_html($per_page * 2) . ' ' . $per_page_string ?></a>
						</li>
						<li class="animated_item">
							<a <?php echo $this->woo_active_class($product_count_key, $per_page * 3); ?> data-count="<?php echo esc_attr($per_page * 3) ?>" href=""><?php echo (int) esc_html($per_page * 3) . ' ' . $per_page_string ?></a>
						</li>
					</ul>
