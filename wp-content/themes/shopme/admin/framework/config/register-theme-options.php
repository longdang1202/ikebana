...
$shopme_elements[] = array(
	...
	$shopme_elements[] = array(
		...
		"type" 	=> "upload",
		"id" 	=> "logo_image",
		"desc" 	=> esc_html__('Upload your logo image. Your logo image width must be no more that 166px', 'shopme'),
	...
	$shopme_elements[] = array(
		...
		$shopme_elements[] = array(
			...
			$shopme_elements[] = array(
				...
				"std" 	=> "#4ac4fa",
				"default" 	=> "#4ac4fa",
				"desc" 	=> esc_html__('Key color for links and other elements', 'shopme'),
			);
