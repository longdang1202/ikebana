...
<h2 class="offset_title"><?php esc_html_e('My Dashboard', 'shopme') ?></h2>
...
<div class="theme_box">
	...
	<div class="myaccount_user">
		<h4>
			<?php
			printf(
				__( 'Hello, %1$s (not %1$s? <a href="%2$s">Sign out</a>)', 'shopme' ) . ' ',
...
<div class="table_layout">
	...
	<?php foreach ( $get_addresses as $name => $title ) : ?>
		...
		<div class="table_cell">
			...
			<a href="<?php echo esc_url(wc_get_endpoint_url( 'edit-address', $name )); ?>" class="button_grey middle_btn edit"><?php esc_html_e( 'Edit', 'woocommerce' ); ?></a>
