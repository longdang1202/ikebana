...
<form method="post" class="theme_box lost_reset_password">
	...
	<p class="form-row">
		...
		<input type="submit" class="button button_blue middle_btn" value="<?php echo 'lost_password' == $args['form'] ? esc_html__( 'Reset Password', 'woocommerce' ) : esc_html__( 'Save', 'woocommerce' ); ?>" />
	</p>
