...
?>
<header><h2 class="offset_title"><?php esc_html_e( 'Customer Details', 'woocommerce' ); ?></h2></header>
...
<header class="title">
	<h2 class="offset_title"><?php esc_html_e( 'Billing Address', 'woocommerce' ); ?></h2>
</header>
<address>
...
<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() ) : ?>
	...
	<div class="col-2">
		<header class="title">
			<h3 class="offset_title"><?php esc_html_e( 'Shipping Address', 'woocommerce' ); ?></h3>
		</header>
		<address>
