...
<h2>
	...
	<?php if ( ! $is_iframe ) : ?><a class="close" href="#"><?php esc_html_e( 'Close window [X]', 'yith-wcmp' ) ?></a><?php endif; ?>
</h2>
...
<table class="compare-list" cellpadding="0" cellspacing="0"<?php if ( empty( $products ) ) echo ' style="width:100%"' ?>>
	...
	<?php if ( empty( $products ) ) : ?>
		...
		<tr class="no-products">
			<td><?php esc_html_e( 'No products added in the compare table.', 'yith-wcmp' ) ?></td>
		</tr>
