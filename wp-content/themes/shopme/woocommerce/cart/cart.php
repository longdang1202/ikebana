						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td data-title="Action">
									...
									<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="button_dark_grey icon_btn remove_product remove" title="%s"><i class="icon-cancel-2"></i></a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), esc_html__( 'Remove this item', 'woocommerce' ) ), $cart_item_key ); ?>
								</td>
	...
	<section class="section_offset">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<h3 class="offset_title"><?php esc_html_e('Discount Codes', 'shopme'); ?></h3>
