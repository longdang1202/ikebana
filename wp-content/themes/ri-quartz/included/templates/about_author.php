    ...
    <div class="row">
        ...
        <div class="author-content col-sm-9 col-md-9 pl0">
            ...
            <ul class="author-social">
                ...
                <?php if(get_the_author_meta('twitter')) : ?><li><a target="_blank" class="author-social" href="http://twitter.com/<?php echo esc_url(the_author_meta('twitter')); ?>"><i class="fa fa-twitter"></i></a></li><?php endif; ?>
