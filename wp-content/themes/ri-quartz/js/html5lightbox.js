        ...
        $.fn.html5lightbox = function (options) {
            ...
            inst.showYoutubeVimeo = function (elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function () {
                    ...
                    inst.$elem.show();
                    inst.showData();
                    if (elem[ELEM_TYPE] == 3 && inst.options.inGroup && typeof YT === "object" && typeof YT.Player === "function")new YT.Player("html5boxiframevideo", {
                        events: {
                    ...
                    }); else if (elem[ELEM_TYPE] == 4 && inst.options.inGroup && typeof $f === "function") {
                        var vimeoIframe =
            ...
            inst.showDiv = function (elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function () {
                    ...
                    if ($(divID).length >
                        0)$("#html5lightbox-div").html($(divID).html()); else $("#html5lightbox-div").html("<div class='html5-error'>The specified div ID does not exist.</div>");
                    inst.$elem.show();
                    inst.showData();
                    if (inst.autosliding) {
                        inst.slideTimeout.stop();
            ...
            inst.resizeWindow = function () {
                ...
                if (inst.currentElem[ELEM_TYPE] ==
                    7 || inst.currentElem[ELEM_TYPE] == 10) {
            ...
            inst.calcElemSize = function (sizeObj, keepratio) {
                ...
                if (inst.options.fullscreenmode && winWidth > inst.options.navarrowsbottomscreenwidth || (inst.options.isTouch && inst.options.navarrowsalwaysshowontouch || inst.options.alwaysshownavarrows) &&
                    winWidth > inst.options.navarrowsbottomscreenwidth)w0 -= 64;
                if (sizeObj.w > w0) {
            ...
            inst.embedFlash = function ($container, src,
                                        wmode, flashVars) {
