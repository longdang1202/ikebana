		...
		<div class="slider-home-2">
			...
			<div class="slide">
				<a href="<?php echo get_the_permalink($post_slider->ID) ?>">
					<img src="<?php echo bfi_thumb(wp_get_attachment_url(get_post_thumbnail_id($post_slider->ID)),array('width' => 1170,'height'=> 468)) ?>" alt="">
				</a>
