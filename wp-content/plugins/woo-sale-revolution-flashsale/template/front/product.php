...
class WC_flash_sale_Product {
	...
	public function __construct()
	{
		...
		add_action( 'woocommerce_after_thumbnail', array(&$this, 'countdown_htmla') );
		add_action( 'woocommerce_before_add_to_cart_form', array(&$this, 'countdown_htmla') );
...
//			add_filter( 'woocommerce_variable_sale_price_html', array(&$this, 'on_price_htmla'), 10, 2 );
	...
	public function countdown_htmla() {
		...
		if ($timer != "") {
			...
			$html.='
				<div class="fl-pcountdown-cnt">
					<span class="countdown_title">'.__('This limited offer ends in:','pw_wc_flash_sale').'</span>
